/*****************************************************
*   Originally pulled from UM QML MessageStack.qml
*   https://github.com/Ultimaker/Uranium/blob/master/UM/Qt/qml/UM/MessageStack.qml
*
*   Modified by Teton Simulation Software
******************************************************/
...
ListView {
    ...
    model: SmartSlice.SmartSliceMessageModel { }
    ...
    delegate: Rectangle {
        ...
        Item {
            ...
            Button {
                ...
                onClicked: base.model.removeSmartSliceMessage(model.id)
        ...
        Label {
            ...
            color: UM.Theme.getColor("text")
            font: UM.Theme.getFont(model.font)
            wrapMode: Text.Wrap
            renderType: Text.NativeRendering
            linkColor: UM.Theme.getColor("text_link")
        }
